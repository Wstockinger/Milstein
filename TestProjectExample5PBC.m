%copyright Wolfgang Stockiner 2020
...
relerrorStrongFinal4 =zeros(rep,7);
relerrorStrongFinalT4 =zeros(rep,7);
relerrorStrongFinalT144 =zeros(rep,7);
relerrorStrongFinalRef4 =zeros(rep,7);
...
[X1FT,X1CT,X11FT,X11CT] = TamedEulerMilsteinRevisionPaperEx52(M(1),N,T,6);
[X2FT,X2CT,X22FT,X22CT] = TamedEulerMilsteinRevisionPaperEx52(M(2),N,T,7);
[X3FT,X3CT,X33FT,X33CT] = TamedEulerMilsteinRevisionPaperEx52(M(3),N,T,8);
[X4FT,X4CT,X44FT,X44CT] = TamedEulerMilsteinRevisionPaperEx52(M(4),N,T,9);
[X5FT,X5CT,X55FT,X55CT] = TamedEulerMilsteinRevisionPaperEx52(M(5),N,T,10);
[X6FT,X6CT,X66FT,X66CT] = TamedEulerMilsteinRevisionPaperEx52(M(6),N,T,11);
[X7FT,X7CT,X77FT,X77CT] = TamedEulerMilsteinRevisionPaperEx52(M(7),N,T,12);

[YF,YC,ZF,ZC] = TamedEulerMilsteinRevisionPaper1(M(1),N,T,6);
[Y1F,Y1C,Z1F,Z1C] = TamedEulerMilsteinRevisionPaper1(M(2),N,T,7);
[Y2F,Y2C,Z2F,Z2C] = TamedEulerMilsteinRevisionPaper1(M(3),N,T,8);
[Y3F,Y3C,Z3F,Z3C] = TamedEulerMilsteinRevisionPaper1(M(4),N,T,9);
[Y4F,Y4C,Z4F,Z4C] = TamedEulerMilsteinRevisionPaper1(M(5),N,T,10);
[Y5F,Y5C,Z5F,Z5C] = TamedEulerMilsteinRevisionPaper1(M(6),N,T,11);
[Y6F,Y6C,Z6F,Z6C] = TamedEulerMilsteinRevisionPaper1(M(7),N,T,12);
...
legend('Tamed Euler scheme (1) (Example 4)', 'Tamed Euler scheme (1) (Example 5)', 'Full-Tamed Milstein scheme (1) (Example 4)','Full-Tamed Milstein scheme (1) (Example 5)' , 'slope -1','slope -0.5','location','northeast')
