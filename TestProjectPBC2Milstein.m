...
[X1FT,X1CT,X11FT,X11CT]=TamedEulerMilstein1(M(1),NN(1),T,4);
[X2FT,X2CT,X22FT,X22CT]=TamedEulerMilstein1(M(1),NN(2),T,4);
[X3FT,X3CT,X33FT,X33CT]=TamedEulerMilstein1(M(1),NN(3),T,4);
[X4FT,X4CT,X44FT,X44CT]=TamedEulerMilstein1(M(1),NN(4),T,4);
[X5FT,X5CT,X55FT,X55CT]=TamedEulerMilstein1(M(1),NN(5),T,4);

[X1FTA,X1CTA,X11FTA,X11CTA]=TamedEulerMilstein1(M(2),NN(1),T,5);
[X2FTA,X2CTA,X22FTA,X22CTA]=TamedEulerMilstein1(M(2),NN(2),T,5);
[X3FTA,X3CTA,X33FTA,X33CTA]=TamedEulerMilstein1(M(2),NN(3),T,5);
[X4FTA,X4CTA,X44FTA,X44CTA]=TamedEulerMilstein1(M(2),NN(4),T,5);
[X5FTA,X5CTA,X55FTA,X55CTA]=TamedEulerMilstein1(M(2),NN(5),T,5);

[X1FTB,X1CTB,X11FTB,X11CTB]=TamedEulerMilstein1(M(3),NN(1),T,6);
[X2FTB,X2CTB,X22FTB,X22CTB]=TamedEulerMilstein1(M(3),NN(2),T,6);
[X3FTB,X3CTB,X33FTB,X33CTB]=TamedEulerMilstein1(M(3),NN(3),T,6);
[X4FTB,X4CTB,X44FTB,X44CTB]=TamedEulerMilstein1(M(3),NN(4),T,6);
[X5FTB,X5CTB,X55FTB,X55CTB]=TamedEulerMilstein1(M(3),NN(5),T,6);
